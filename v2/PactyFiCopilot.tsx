...
export default function PactyFiCopilot({ onFillForm, currentForm }: PactyFiCopilotProps) {
  ...
  const getCommsDrafts = () => {
    ...
    const invoiceUrl = 'https://pactyfi.com/pay/demo-id'; // placeholder URL representing what is generated
  ...
  const getStablecoinExplain = () => {
    return {
      ...
      benefits: [
        ...
        "6× cheaper: PactyFi charges only a 0.5% fee compared to 2.9% + fixed costs for Stripe/PayPal.",
      ...
      {activeTab === 'comms' && (
        <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem', flex: 1 }}>
          ...
          <p style={{ color: 'var(--text-secondary)', fontSize: '0.8125rem', lineHeight: 1.4 }}>
            Generate messages to share your payment request. PactyFi prepares these automatically using your current invoice details.
          </p>
